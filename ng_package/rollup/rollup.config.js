...
process.env['NODE_PATH'] = process.env['JS_BINARY__RUNFILES'] + '/rules_angular/node_modules'

//throw new Error(process.env['JS_BINARY__RUNFILES'] + '/rules_angular/node_modules')
